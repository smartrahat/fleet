...
class Blueprint
{
    ...
    /**
     * Add nullable and unsigned company_id and user_id to the table.
     *
     * @return void
     * create by smartrahat date: 2017-08-27 Time: 12:47PM
     */
    ...
    /**
     * Create a new authority column on table
     * @param $column
     * @return Fluent
     * create by smartrahat date: 2017-08-27 Time: 12:47PM
     */
    public function authority($column)
    {
        return $this->addColumn('integer',$column);
    }

    /**
     * Create relationship with company and user on table
     *
     * create by smartrahat date: 2017-08-27 Time: 03:40PM
     */
    public function foreignAuthority()
    {
        $this->foreign('company_id')->references('id')->on('companies')->onDelete('cascade');
        $this->foreign('user_id')->references('id')->on('users');
    }

    /**
     * Drop company and user foreign key from table
     *
     * create by smartrahat date: 2017-08-27 Time: 03:47PM
     */
    public function dropForeignAuthority()
    {
        $this->dropForeign(['company_id']);
