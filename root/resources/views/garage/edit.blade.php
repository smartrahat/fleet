                ...
                <div class="col-xs-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">Garage</h2>
                        </header>

                        <div class="panel-body">
                            {{ Form::model($garage,['action'=>['GarageController@update',$garage->id],'method'=>'patch','class'=>'form-horizontal']) }}
                            ...
                            <div class="form-group {{ $errors->has('address')? 'has-error':'' }}">
                                {{ Form::label('address','Description:',['class'=>'col-md-3 control-label']) }}
                                <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-striped table-condensed mb-none">
                                    ...
                                    @foreach($garages as $garage)
                                        <tr>
                                            ...
                                            <td>
                                                {{ Form::open(['action'=>['GarageController@destroy',$garage->id],'method'=>'delete']) }}
