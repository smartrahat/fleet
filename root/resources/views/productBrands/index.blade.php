            ...
            <div class="col-xs-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(['action'=>'ProductBrandController@store','method'=>'post','class'=>'form-horizontal']) }}
                            ...
                            <table class="table table-bordered table-striped table-condensed mb-none">
                                ...
                                @foreach($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            {{ Form::open(['action'=>['ProductBrandController@destroy',$brand->id],'method'=>'delete','onsubmit'=>'return confirmDelete()']) }}
...
@section('script')
    <script>
        function confirmDelete(){
            var x = confirm('Are you sure you want to delete this brand?');
            return !!x;
        }
    </script>
@stop